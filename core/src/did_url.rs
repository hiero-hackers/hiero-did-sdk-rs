...
mod tests {
    ...
    fn bare_did() {
        // 1. parse the input —
        let url: HederaDidUrl = "did:hedera:testnet:abc123_0.0.1234".parse().expect("should parse");
    ...
    #[test]
    fn with_fragment() {
        let url: HederaDidUrl =
            "did:hedera:testnet:abc123_0.0.1234#key-1".parse().expect("should parse");
    ...
    fn with_path_and_fragment() {
        let url: HederaDidUrl =
            "did:hedera:testnet:abc123_0.0.1234/some/path#key-1".parse().expect("should parse");
